...
cp buildroot_openlinux/buildroot/package/meson-mali/lib/arm64/r7p0/m450/wayland/drm/libMali.so p2/usr/lib/mali/
cd p2/usr/lib/mali
...
ln -s libwayland-egl.so.1 libwayland-egl.so.1.0.0
cd -
...
# Move existing libs elsewhere
mkdir -p p2/usr/lib/mesa
mv p2/usr/lib/libgbm.so* p2/usr/lib/mesa
mv p2/usr/lib/libEGL*.so* p2/usr/lib/mesa
mv p2/usr/lib/libGLES*.so* p2/usr/lib/mesa
mv p2/usr/lib/libwayland-egl.so* p2/usr/lib/mesa
